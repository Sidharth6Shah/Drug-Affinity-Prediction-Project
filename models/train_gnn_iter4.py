...
def main():
    ...
    for epoch in range(numEpochs):
        ...
        if valRmse < bestValRmse:
            bestValRmse = valRmse
            patienceCounter = 0
            torch.save(model.state_dict(), 'results/stratified_split/iter4_best_model.pt')
        else:
            patienceCounter += 1
    ...
    model.load_state_dict(torch.load('results/stratified_split/iter4_best_model.pt'))
    ...
    with open('results/stratified_split/iter4_results.json', 'w') as f:
