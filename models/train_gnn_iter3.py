...
def main():
    ...
    for epoch in range(numEpochs):
        ...
        if valRmse < bestValRmse:
            bestValRmse = valRmse
            patienceCounter = 0
            torch.save(model.state_dict(), 'results/best_gnn_iter3_model.pt')
    ...
    print("="*70)
    model.load_state_dict(torch.load('results/best_gnn_iter3_model.pt'))
    ...
    with open('results/gnn_iter3_results.json', 'w') as f:
